  ...
  return (
    <div className="space-y-6">
      <div className="rounded-3xl border border-gray-100 bg-white p-6 shadow-sm overflow-hidden relative">
        ...
        <h3 className="text-lg font-bold text-gray-900 border-b border-gray-50 pb-4 mb-6">Order Summary</h3>
        ...
        <div className="space-y-5">
          ...
          <div className="space-y-3 pt-4 border-t border-gray-50">
            ...
            <div className="flex items-center justify-between pt-3 border-t border-gray-100">
              <span className="text-sm font-bold text-gray-900 uppercase tracking-widest">Total Pay</span>
      ...
      <div className="rounded-2xl bg-emerald-950 p-5 text-white flex items-start gap-4">
        ...
        <div>
            <h5 className="font-bold text-[14px]">Secure Payment Guaranteed</h5>
            <p className="mt-1 text-xs text-emerald-100/60 leading-relaxed">Your data is encrypted and protected. We use industry-standard security protocols for every transaction.</p>
        </div>
      </div>
    </div>
  );
